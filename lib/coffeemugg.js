(function() {
  var CMContext, NEWLINE, coffeemugg, elements, merge_elements;
 ...
 nobr spacer tt',
  ...
  exports.CMContext = CMContext = (function() {
    ...
    CMContext.prototype.render_contents = function() {
      ...
      switch (typeof contents) {
        ...
        case 'number':
        case 'boolean':
          return this.text(this.esc(contents));
        case 'function':
          if (this.format) {
          ...
          if (typeof result === 'string') return this.text(this.esc(result));
      }
    };

    CMContext.prototype.render = function() {
      this.render_contents.apply(this, arguments);
    ...
    CMContext.extend = function(object) {
      var key, value, _ExtendedContext;
  ...
  coffeemugg.render = function() {
    ...
    return context.render.apply(context, [template].concat(__slice.call(args)));
  };
  ...
  coffeemugg.debug = function() {
    ...
    context.render_contents.apply(context, [template].concat(__slice.call(args)));
    return console.log('' + context.debugString());
  };
