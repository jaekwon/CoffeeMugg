 ...
 nobr spacer tt',
  ...
  exports.CMContext = CMContext = (function() {
    ...
    CMContext.prototype.render_idclass = function(str) {
      var c, classes, i, id, _j, _k, _len1, _len2, _ref1;
      classes = [];
      _ref1 = str.split('.');
  ...
  coffeemugg.render = function() {
    ...
    if (typeof template === 'string' && (coffee != null)) {
      eval("template = function () {" + (coffee.compile(template, {
        bare: true
      })) + "}");
    }
