...
(function() {
  var CMContext, HTMLPlugin, NEWLINE, coffee, coffeemugg, elements, g_context, merge_elements,
    __slice = [].slice;
    ...
    context = {
      ...
      render_attrs: function(obj) {
        ...
        for (k in obj) {
          ...
          if (v) {
            this.text(" " + k + "=\"" + (String(v).replace(/&/g, "&amp;").replace(/"/g, "&quot;")) + "\"");
          }
        }
        return null;
      },
      ...
      doctype: function(type) {
        ...
        return this.textnl(coffeemugg.doctypes[type]);
      },
      textnl: function(txt) {
        this.text("" + this._newline + this._indent + txt);
        if (this.options.format) {
          this._newline = "\n";
        }
        return null;
