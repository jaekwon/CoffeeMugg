...
(function() {
  var CMContext, HTMLPlugin, NEWLINE, coffee, coffeemugg, coffeescript_helpers, context, elements, logger, merge_elements,
    __slice = [].slice,
 ...
 nobr spacer tt',
  ...
  this.CMContext = CMContext = function(options) {
    ...
    context = {
      ...
      tag: function() {
        ...
        return this.renderTag(name, args);
      },
  ...
  HTMLPlugin = {
    installOn: function(context) {
      var contextFunctions, key, tag, value, _fn, _i, _len, _ref,
        _this = this;
      _ref = coffeemugg.tags.concat(coffeemugg.self_closing);
      _fn = function(tag) {
        console.log("!!! " + tag);
        return context[tag] = function() {
          return this.renderTag(tag, arguments);
        };
      };
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tag = _ref[_i];
